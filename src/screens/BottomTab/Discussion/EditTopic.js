...
import { putEditTopic } from '../../../Ultils/async';
import { getCategoriesApi } from '../../../Ultils/async';

export default function CreatPost({ navigation, route }) {
    ...
    const onEdit = (detail) => async () => {
        try {
            ...
            const response = await putEditTopic(detail.id, { title: title, content: content, categories: tagsID });
